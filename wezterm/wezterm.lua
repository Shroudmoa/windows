...
-- local fish_path = "/.config/wezterm/fish"
...
local fav_themes = { "tokyonight", "Cloud (terminal.sexy)" }
...
-- Keys
 config.leader = { key = "e", mods = "ALT", timeout_milliseconds = 2000 }
config.keys = {
  ...
  -- Pane
  { key = "q",         mods = "LEADER", action = act.SplitVertical { domain = "CurrentPaneDomain" } },
